...
typedef enum {
  UNKOBJ, TYPTAG, OBJNAM, BCNCAR, BCNISD, BCNLAT, BCNSAW, BCNSPP,
...
typedef enum {
  ...
  DOLPHIN, DEVDOLPHIN, SIGNAL, PILOT, MAJOR, MINOR, HOUSE, CHIMNEY, DISH, FLAGSTAFF, FLARESTACK, MONUMENT, LANDTOWER, WINDMOTOR,
  WATERTOWER, MAST, WINDSOCK, COLUMN, OBELISK, STATUE, LANDCROSS, DOME, RADAR, WINDMILL, SPIRE, PLATFORM, FPSO
} Shp_t;
