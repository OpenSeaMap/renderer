...
typedef enum { IALAA, IALAB, CEVNI, RIWR, OTHER } Reg_t;
typedef struct { Reg_t key; char *val; } RegSTR_t;
typedef enum { S, A, L, E, F, I } Cnv_t;

typedef enum {
  UNKOBJ, MASTER, OBJNAM, BCNCAR, BCNISD, BCNLAT, BCNSAW, BCNSPP, BOYCAR, BOYISD, BOYLAT, BOYSAW, BOYSPP, BOYINB, LITMAJ, LITMIN, LNDMRK,
  LITFLT, LITVES, TOPMAR, DAYMAR, FOGSIG, LIGHTS, RADRFL, RTPBCN, MORFAC, SISTAW, SISTAT, CGUSTA, PILBOP, RSCSTA, RDOSTA, RADSTA,
  OFSPLF, BUISGL, NOTMRK, PILPNT, BCNWTW, BOYWTW, RESARE, SLCONS, ADMARE, AIRARE, ACHBRT, ACHARE, BERTHS, BRIDGE, BUAARE, CBLARE,
  CBLOHD, CBLSUB, CANALS, CANBNK, CTSARE, CAUSWY, CTNARE, CHKPNT, COALNE, CONZNE, COSARE, CTRPNT, CONVYR, CRANES, CURENT, CUSZNE,
  DAMCON, DWRTCL, DWRTPT, DEPARE, DEPCNT, DISMAR, DOCARE, DRGARE, DRYDOC, DMPGRD, DYKCON, EXEZNE, FAIRWY, FNCLNE, FERYRT, FSHZNE,
  FSHFAC, FSHGRD, FLODOC, FORSTC, FRPARE, GATCON, GRIDRN, HRBARE, HRBFAC, HULKES, ICEARE, ICNARE, ISTZNE, LAKARE, LAKSHR, LNDARE,
  LNDELV, LNDRGN, LOCMAG, LOKBSN, LOGPON, MAGVAR, MARCUL, MIPARE, NAVLNE, OBSTRN, OSPARE, OILBAR, PIPARE, PIPOHD, PIPSOL, PONTON,
  PRCARE, PRDARE, PYLONS, RADLNE, RADRNG, RDOCAL, RAILWY, RAPIDS, RCRTCL, RECTRC, RCTLPT, RETRFL, RIVERS, RIVBNK, ROADWY, RUNWAY,
  SNDWAV, SEAARE, SPLARE, SBDARE, SILTNK, SLOTOP, SLOGRD, SMCFAC, SOUNDG, SPRING, SQUARE, STSLNE, SUBTLN, SWPARE, TESARE, TS_PRH,
  TS_PNH, TS_PAD, TS_TIS, T_HMON, T_NHMN, T_TIMS, TIDEWY, TSELNE, TSSBND, TSSCRS, TSSLPT, TSSRON, TSEZNE, TUNNEL, TWRTPT, UWTROC,
  UNSARE, VEGATN, WATTUR, WATFAL, WEDKLP, WRECKS, TS_FEB, M_ACCY, M_CSCL,	M_COVR,	M_HDAT,	M_HOPA,	M_NPUB,	M_NSYS,	M_PROD,	M_QUAL,
  M_SDAT,	M_SREL,	M_UNIT,	M_VDAT,	C_AGGR,	C_ASSO,	C_STAC, $AREAS, $LINES,	$CSYMB, $COMPS, $TEXTS, WTWAXS, WTWPRF, BRGARE, BUNSTA,
  COMARE, HRBBSN, LOKARE, LKBSPT, PRTARE, REFDMP, RTPLPT, TERMNL, TRNBSN, WTWARE, WTWGAG, TISDGE, VEHTRF, EXCNST, LG_SDM, LG_VSP
} Obj_t;
typedef struct { Obj_t key; char *val; } ObjSTR_t;

typedef enum {
  UNKATT, CATEGORY, SHAPE, COLOUR, NAME, COLPAT, GROUP, PERIOD, RANGE, COMCHA, ADDMRK, AGENCY, BURDEP, CALSGN, CPDATE, CSCALE, CONDTN,
  CONRAD, CONVIS, CURVEL, DATEND, DATSTA, DRVAL1, DRVAL2, DUNITS, ELEVAT, ESTRNG, EXCLIT, EXPSOU, FUNCTN, HEIGHT, HUNITS, HORACC,
  HORCLR, HORLEN, HORWID, ICEFAC, INFORM, JRSDTN, LIFCAP, LITCHR, LITVIS, MARSYS, MLTYLT, NATION, NATCON, NATSUR, NATQUA, NMDATE,
  ORIENT, PEREND, PERSTA, PICREP, PILDST, PRCTRY, PRODCT, PUBREF, QUASOU, RADWAL, RADIUS, RECDAT, RECIND, RYRMGV, RESTRN, SCAMAX, SCAMIN,
  SCVAL1, SCVAL2, SECTR1, SECTR2, SHIPAM, SIGFRQ, SIGGEN, SOUACC, SDISMX, SDISMN, SORDAT, SORIND, STATUS, SURATH, SUREND, SURSTA, SURTYP,
  TECSOU, TXTDSC, TIMEND, TIMSTA, TRAFIC, VALACM, VALDCO, VALLMA, VALMAG, VALSOU, VERACC, VERCLR, VERCCL, VERCOP, VERCSA, VERDAT, VERLEN,
  WATLEV, CAT_TS, PUNITS, NINFOM, NOBJNM, NPLDST, NTXTDS, HORDAT, POSACC, QUAPOS, CLSDNG, DIRIMP, DISBK1, DISBK2, DISIPU, DISIPD, ELEVA1,
  ELEVA2, FNCTNM, WTWDIS, BUNVES, COMCTN, HORCLL, HORCLW, TRSHGD, UNLOCD, HIGWAT, HIGNAM, LOWWAT, LOWNAM, MEAWAT, MEANAM, OTHWAT, OTHNAM,
  REFLEV, SDRLEV, VCRLEV, SCHREF, USESHP, CURVHW, CURVLW, CURVMW, CURVOW, APTREF, SHPTYP, UPDMSG
} Att_t;
...
typedef enum {
  ...
  SLC_BWTR, SLC_GRYN, SLC_MOLE, SLC_PIER, SLC_PPIR, SLC_WHRF, SLC_TRWL, SLC_RPRP, SLC_RVMT, SLC_SWAL,
  SLC_LSTP, SLC_RAMP, SLC_SWAY, SLC_FNDR, SLC_SFWF, SLC_OFWF, SLC_LRMP, SLC_LKWL
} Cat_t;
...
typedef enum {
  NOTOP, CYL, CONE, CONE_INV, SPHERE, SALTIRE, NORTH, SOUTH, EAST, WEST, ISOL, BOARD, RHOMBUS, CIRCLE, TRIANGLE, TRIANGLE_INV, RECTEQ
} Top_t;
